    ...
    public String parseMess(String textMess) {
        ...
        if (textMess.equals("/start")) {
            ...
            if (operation.equals("Лонг")) {
                ...
                profit1 = ((exitPrice1 - entryPoint) * amount1);
                BigDecimal resultProfit1 = new BigDecimal(profit1).setScale(1, HALF_UP);


                cost2 = 0.95 * entryPoint;
                BigDecimal resultCost2 = new BigDecimal(cost2).setScale(4, HALF_UP);
                averageCost = (cost2 + entryPoint) / 2;
                BigDecimal resultAverageCost = new BigDecimal(averageCost).setScale(4, HALF_UP);
                amount2 = amount1;
                exitPrice = 1.05*averageCost;
                BigDecimal resultExitPrice =  new BigDecimal(exitPrice).setScale(4,HALF_UP);
                profit = (exitPrice-averageCost) *(amount1+amount2);
                BigDecimal resultProfit = new BigDecimal(profit).setScale(1, HALF_UP);
                ...
                profit2 = (exitPrice2 - averageCost2) * (amount1 + amount2 + amount3);
                BigDecimal resultProfit2 = new BigDecimal(profit2).setScale(1, HALF_UP);
                ...
                exitPrice1 = 1.03 * entryPoint;
                BigDecimal resultExitPrice1 = new BigDecimal(exitPrice1).setScale(4, HALF_UP);
                profit1 = (int) ((exitPrice1 - entryPoint) * amount1);
